...
public class OrderHistoryGroupResponseV2_1 {
    private int id;
    private String name;
    ...
    @JsonProperty("store")
    private List<OrderHistoryStoreResponseV2_1> store;
    private Map<Integer, GroupUserStatusResponse> userStatus;
    private boolean isManager;

    public OrderHistoryGroupResponseV2_1() {
    }

    public OrderHistoryGroupResponseV2_1(int id, String name, Timestamp startTime, Timestamp endTime, boolean isLocked) {
        this.id = id;
        this.name = name;
    ...
    public List<OrderHistoryStoreResponseV2_1> getStore() {
        return store;
    }

    public void setStore(List<OrderHistoryStoreResponseV2_1> store) {
        this.store = store;
    }
