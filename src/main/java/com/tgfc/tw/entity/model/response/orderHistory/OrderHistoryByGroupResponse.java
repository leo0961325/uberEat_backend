...
public class OrderHistoryByGroupResponse {
    ...
    public OrderHistoryByGroupResponse(){

    }

    public OrderHistoryByGroupResponse(int productId, String productName, int productPrice, int optionId, String optionName, int optionPrice, int orderId, int count) {
